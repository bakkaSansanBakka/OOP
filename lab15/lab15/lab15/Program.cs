...
namespace lab15
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            /*newDomain.Load(@"E:\2 курс\OOP\lab14\lab14\lab14\bin\Debug\System.Buffers.dll");
        ...
        {
            int num = (int)n;
            using (StreamWriter sw = new StreamWriter(@"E:\2 курс\OOP\lab15\lab15\lab15\file.txt", false))
            {
        ...
        public static void CountEven(object n)
        {
            ...
            lock (objlocker)
            {
                using (StreamWriter sw = new StreamWriter(@"E:\2 курс\OOP\lab15\lab15\lab15\file1.txt", true))
                {
                    for (int i = 1; i < num + 1; i++)
                    {
                        if (i % 2 == 0)
