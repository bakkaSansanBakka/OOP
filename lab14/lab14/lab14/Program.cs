...
namespace lab14
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            using (FileStream fs = new FileStream(@"E:\2 курс\OOP\lab14\lab14\lab14\document1.dat", FileMode.OpenOrCreate))
            {
            ...
            using (FileStream fStream = new FileStream(@"E:\2 курс\OOP\lab14\lab14\lab14\document2Soap.soap", FileMode.OpenOrCreate))
            {
            ...
            using (StreamWriter sw = new StreamWriter(@"E:\2 курс\OOP\lab14\lab14\lab14\document.json", false))
            {
                sw.Write(jsonString);
            }
            ...
            using (FileStream fs = new FileStream(@"E:\2 курс\OOP\lab14\lab14\lab14\document.xml", FileMode.OpenOrCreate))
            {
            ...
            using (FileStream fs = new FileStream(@"E:\2 курс\OOP\lab14\lab14\lab14\documents.dat", FileMode.OpenOrCreate))
            {
            ...
            xDoc.Load(@"E:\2 курс\OOP\lab14\lab14\lab14\document.xml");
            ...
            xdoc.Add(parrots);
            xdoc.Save(@"E:\2 курс\OOP\lab14\lab14\lab14\parrots.xml");

            XDocument xdoc1 = XDocument.Load(@"E:\2 курс\OOP\lab14\lab14\lab14\parrots.xml");
